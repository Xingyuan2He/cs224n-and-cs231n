...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        elif transition == "LA":  # second top of stack as dependent
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        m_batch_parses = unfinished_parses[:batch_size]
        next_transitions = model.predict(m_batch_parses)
        for p, t in zip(m_batch_parses, next_transitions):
            p.parse_step(t)

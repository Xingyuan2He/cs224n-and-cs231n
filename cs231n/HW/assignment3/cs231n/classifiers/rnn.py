...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # 2
        embed_word_in, embed_cache_in = word_embedding_forward(
            captions_in, W_embed)
        # 3
        if self.cell_type == 'rnn':
            h, cache = rnn_forward(embed_word_in, h0, Wx, Wh, b)
        else:
            h, cache = lstm_forward(embed_word_in, h0, Wx, Wh, b)
        # 4
        ...
        if self.cell_type == 'rnn':
            ...
            dout, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(
                dout, cache)
        # b2
        grads['W_embed'] = word_embedding_backward(dout, embed_cache_in)
        # b1
